...
public class Main {
    public static String harfnotuHesapla(String isim,int vize1,int vize2,int finalnot) {
        ...
        double toplamnot = (vize1 * 3 / 10.0) + (vize2 * 3 / 10.0) + (finalnot * 4 / 10.0); /*Not hesaplama alanımız */
    ...
    public static void main(String[] args) {
       ...
       try(Scanner scanner = new Scanner(new FileReader("dosya.txt"));
           ...
           while (scanner.hasNextLine()) {   /*Her Öğrencinin notunu oku */
               ...
               String cikti = harfnotuHesapla(ogrenciArray[0],vize1 , vize2, finalnot); /*Hesaplanan notu çıktı olarak yazdır  */
               writer.write(cikti + "\n");
